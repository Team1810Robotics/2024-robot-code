...
public class SwerveModule {
     ...
     * <b>WARNING: If you are not using one of the functions from {@link SwerveDrive} you may screw
     * up {@link SwerveDrive#kinematics}</b>
     *
    ...
    public void setDesiredState(SwerveModuleState desiredState, boolean isOpenLoop, boolean force) {
        desiredState =
                SwerveModuleState.optimize(
                        desiredState, Rotation2d.fromDegrees(getAbsolutePosition()));
