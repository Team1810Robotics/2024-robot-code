...
public class SwerveController {
     ...
     *
     * @param xInput X joystick input for the robot to move in the X direction. X = xInput *
     *     maxSpeed
    ...
    /**
     * Set a new maximum angular velocity that is different from the auto-generated one. Modified
     * the {@link SwerveControllerConfiguration#maxAngularVelocity} field which is used in the
     * {@link SwerveController} class for {@link ChassisSpeeds} generation.
     *
