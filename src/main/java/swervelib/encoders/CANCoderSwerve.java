...
public class CANCoderSwerve extends SwerveAbsoluteEncoder
{
  ...
  public double getAbsolutePosition()
  {
    ...
    switch (encoder.getDeviceID()) { // TODO Test if works - One thing I changed
        case Swerve.FL_CANCODER_ID:
            offset = Swerve.FL_CANCODER_OFFSET;
            break;
        case Swerve.FR_CANCODER_ID:
            offset = Swerve.FR_CANCODER_OFFSET;
            break;
        case Swerve.BL_CANCODER_ID:
            offset = Swerve.BL_CANCODER_OFFSET;
            break;
        case Swerve.BR_CANCODER_ID:
            offset = Swerve.BR_CANCODER_OFFSET;
            break;
    }
    /* double offset = 0.0;
