...
public class ModuleJson {
     ...
     *
     * <p>Conversion factor applied to the motor controllers PID loops. Can be calculated with
     * {@link swervelib.math.SwerveMath#calculateDegreesPerSteeringRotation(double, double)} for
     * angle motors or {@link swervelib.math.SwerveMath#calculateMetersPerRotation(double, double,
     * double)} for drive motors.
     */
    ...
    public SwerveModuleConfiguration createModuleConfiguration(
        ...
        } else if (physicalCharacteristics.conversionFactor != null
                && this.conversionFactor == null) {
