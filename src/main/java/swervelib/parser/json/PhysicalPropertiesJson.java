...
public class PhysicalPropertiesJson {
     ...
     * swervelib.math.SwerveMath#calculateDegreesPerSteeringRotation(double, double)} for angle
     * motors or {@link swervelib.math.SwerveMath#calculateMetersPerRotation(double, double,
