...
public class SwerveParser {
     ...
     *     acceleration used in {@link swervelib.SwerveController} and drive feedforward in {@link
     *     SwerveMath#createDriveFeedforward(double, double, double)}.
     * @param angleMotorConversionFactor Angle (AKA azimuth) motor conversion factor to convert
     *     motor controller PID loop units to degrees, usually created using {@link
     *     SwerveMath#calculateDegreesPerSteeringRotation(double, double)}.
     * @param driveMotorConversion Drive motor conversion factor to convert motor controller PID
     *     loop units to meters per rotation, usually created using {@link
     ...
     * @param maxSpeed Maximum speed of the robot in meters per second for normal+angular
     *     acceleration in {@link swervelib.SwerveController} of the robot.
     * @param angleMotorConversionFactor Angle (AKA azimuth) motor conversion factor to convert
     *     motor controller PID loop units to degrees, usually created using {@link
     *     SwerveMath#calculateDegreesPerSteeringRotation(double, double)}.
     * @param driveMotorConversion Drive motor conversion factor to convert motor controller PID
