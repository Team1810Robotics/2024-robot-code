...
public class SwerveMath {
    ...
    /**
     * Calculate the meters per rotation for the integrated encoder. Calculation: (PI * WHEEL
     * DIAMETER IN METERS) / (GEAR RATIO * ENCODER RESOLUTION)
     *
