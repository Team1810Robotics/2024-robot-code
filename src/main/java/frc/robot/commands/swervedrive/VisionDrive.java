...
public class VisionDrive extends Command{
    ...
    CommandJoystick rotationController = RobotContainer.rotationController;

    public VisionDrive(SwerveSubsystem drivetrain, DoubleSupplier vX, DoubleSupplier vY, DoubleSupplier omega) {
